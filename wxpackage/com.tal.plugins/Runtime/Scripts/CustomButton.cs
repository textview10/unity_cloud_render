...
using UnityEngine;
    ...
    public delegate void ButtonState();
    /// <summary>
    /// 自己重写的 Button 按钮
    /// 1、单击
    /// 2、双击
    ...
    public class CustomButton : Selectable, IPointerClickHandler, ISubmitHandler
    {
        ...
        public void Test()
        {
            Debug.LogError("CustomButton Test()");
        }
        ...
        public ButtonState buttonDownStateDele;
        public ButtonState buttonUpStateDele;
 
        private bool my_isStartPress = false;
 
        private float my_curPointDownTime = 0f;
 
        private float my_longPressTime = 0.05f;
        ...
        public override void OnPointerDown(PointerEventData eventData)
        {
            ...
            if (buttonDownStateDele != null)
            {
                buttonDownStateDele.Invoke();
            }
        ...
        public override void OnPointerUp(PointerEventData eventData)
        {
            ...
            my_isStartPress = false;
            if (buttonUpStateDele != null)
            {
                buttonUpStateDele.Invoke();
            }
